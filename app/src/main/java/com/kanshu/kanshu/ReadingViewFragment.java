...
public class ReadingViewFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        transition.setStagger(LayoutTransition.CHANGE_DISAPPEARING,1);
        transition.setStagger(LayoutTransition.CHANGE_APPEARING,1);
        transition.setStartDelay(LayoutTransition.DISAPPEARING, 1);
        transition.setStartDelay(LayoutTransition.APPEARING, 1);
        transition.setStartDelay(LayoutTransition.CHANGE_DISAPPEARING,2);
        transition.setStartDelay(LayoutTransition.CHANGE_APPEARING,2);
