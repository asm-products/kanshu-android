...
public class RangeBar extends View {
    ...
    protected boolean mFirstSetTickCount = true;
    ...
    private Bar mBar;
    protected ConnectingLine mConnectingLine;
     ...
     */
    protected boolean indexOutOfRange(int leftThumbIndex, int rightThumbIndex) {
     ...
     */
    protected void pressThumb(Thumb thumb) {
        if (mFirstSetTickCount == true)
            mFirstSetTickCount = false;
        thumb.press();
        invalidate();
     ...
     */
    protected void releaseThumb(Thumb thumb) {
     ...
     */
    protected void moveThumb(Thumb thumb, float x) {
